...
function renderContacts(contactsArray){
    //console.log('contactsAray')
    let i=0;
    while(i<contactsArray.lenght){
        ...
        //asignando clases a los elementos creados
        //por eso es bueno haber hecho un maquetado previo
